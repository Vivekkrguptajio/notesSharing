            ...
            <div className="bg-white rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <DropZone
                            onFileUploaded={(url) => setFormData({ ...formData, idCardUrl: url })}
                            initialUrl={formData.idCardUrl}
                        />
                        {/* Hidden input to maintain required validation if needed, or handle validation manually */}
                        <input
                            type="text"
                            required
                            value={formData.idCardUrl}
                            onChange={() => { }} // Read-only invisible input for standard HTML validation
                            className="sr-only"
                            onInvalid={(e) => e.target.setCustomValidity("Please upload your ID card")}
