...
import { FileText, Download, Star, User, CheckCircle, Eye } from "lucide-react";
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 hover:shadow-lg transition-all duration-300 hover:border-indigo-200">
            ...
            <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">{note.subject}</p>
                </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
                ...
                <span className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${getFileTypeColor(note.fileType)}`}>
                    {note.fileType}
                </span>
                {note.verified && (
            ...
            <div className="flex items-center justify-between text-xs sm:text-sm text-gray-600 mb-4">
                <div className="flex items-center gap-1">
                    ...
                    <span className="truncate max-w-[100px] sm:max-w-none">{note.uploadedBy}</span>
                </div>
