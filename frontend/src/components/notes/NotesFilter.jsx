...
import { categories, subjects, semesters, fileTypes } from "./notesdata";

export default function NotesFilter({ onFilterChange, totalNotes }) {
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 mb-6">
            ...
            <div className="mt-4 text-xs sm:text-sm text-gray-600">
                Showing <span className="font-semibold text-gray-900">{totalNotes}</span> notes
            </div>
        </div>
    );
}
